...
public class InterfaceChallengeMain {
	public static void main(String[] args) {
		...
		ajPlayer.setWeapon("stormbringer");
		saveObject(ajPlayer);
//		loadObject(ajPlayer);
		System.out.println(ajPlayer);
		
		//creating monster instance
		ISaveable warewolf = new MonsterClassInterfaceChallenge("Warewolf", 20, 40);
		//implementing the interface but still using the monster class, so cast like this
		System.out.println("Strength: "+((MonsterClassInterfaceChallenge)warewolf).getStrength());
