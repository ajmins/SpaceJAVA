...
/* For this challenge, create an abstract class to define items that can be stored in a list.
   ...
   Create a concrete class from your abstract list item class and use this in a LinkedList class to implement a linked list that will add items in order 
   ...
   Hint: If you are creating classes with names such as List, LinkedList, Node etc, make sure that you create your classes before referring to them. 
   		In previous videos we have often referred to classes that we create later, but if you use names that IntelliJ recognises as Java classes (such
 ...
 */
public class AbstractClassChallengeMain {
	...
	//String stringData = "Darwin Charles Julios Plato Athena Thor Charles";
