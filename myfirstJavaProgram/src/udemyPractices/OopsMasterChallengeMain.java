 ...
 * 
 * All 3 classes should have a method that can be called anytime to show the base price of the hamburger plus all additionals, 
...
public class OopsMasterChallengeMain {

	public static void main(String[] args) {
		
		BaseBurger burger = new BaseBurger("White", "Basc", "Sausage", 3.75);
		double price = burger.calculatePrice();
		burger.addAddition1("Tomato", 0.27);
		burger.addAddition2("Lettuce", 0.77);
		burger.addAddition3("Cheese", 1.27);
		System.out.println("total Burger Price is "+ burger.calculatePrice());
